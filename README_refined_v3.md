...
[![Machine Learning](https://img.shields.io/badge/Machine-Learning-16343B?style=for-the-badge)](#featured-projects)
...
&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="https://scholar.google.com/citations?hl=en&user=dJA-TzEAAAAJ&view_op=list_works"><strong>Google Scholar</strong></a>
&nbsp;&nbsp; | &nbsp;&nbsp;
...
This section summarises the strongest evidence from the portfolio. Instead of listing numbers only, each highlight shows what the evidence demonstrates for healthcare data science and analytics roles.

| Portfolio evidence | What it demonstrates |
|---|---|
| **500,000+ UK Biobank participants analysed** | Experience working with large-scale population health data and cohort-based predictive analytics |
| **0.90 C-index in Type 2 diabetes prediction** | Strong time-to-event modelling, survival analysis and risk stratification capability |
...
<p align="center">
  <img
    src="assets/howiwork.png"
    alt="Healthcare analytics workflow from research question to decision-ready reporting"
    width="100%"
  />
</p>
